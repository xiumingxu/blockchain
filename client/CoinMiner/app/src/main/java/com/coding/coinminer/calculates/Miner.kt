...
//         preHashArrayReversed = reverseByteArray(getByteArrayFromString(b.prevBlockhash))
...
//         merkleRootArrayReversed = reverseByteArray(getByteArrayFromString(b.merkleRoot))
    ...
    private fun initializeTarget() {
        ...
        var targetInt = (mantissa * Math.pow(2.0, 8.0 * (exponent - 3))).toBigDecimal().toBigInteger()
